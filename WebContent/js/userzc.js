...
$(function() {
	...
	$('#accountNo').on('blur', checkAccountNo).on('focus', function() {
		$('#accountError').empty();
	});
	...
	$('#phone').on('blur', checkPhone).on('focus', function() {
		$('#phoneError').empty();
	});

	$('#name').on('blur', checkName).on('focus', function() {
		$('#nameError').empty();
	});

	$('#repwd').on('blur', checkRepwd).on('focus', function() {
		$('#repwdError').empty();
	});
